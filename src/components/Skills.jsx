              ...
              <div className="space-y-4">
                ...
                {category.skills.length > 4 && (
                  <button
                    ...
                    className="w-full py-2 text-sm text-white border rounded-lg hover:bg-slate-800 border-blue-400 hover:border-blue-700 hover:opacity-85 transition-all duration-300"
                  >
                    {showAll[categoryIndex] ? 'Mostrar menos' : 'Mostrar tudo'}
                  </button>
                )}
              </div>
            </div>
